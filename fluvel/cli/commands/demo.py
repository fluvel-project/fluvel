...
@click.option(
    "--theme",
    help="The name of the theme to use for the demo. If not provided, the application's default theme is used.",
)
def demo(theme: str | None) -> None:
    ...
    try:
        ...
        echo("[red](The demo could not be run.)")
        echo(f"[red](Error:) > [yellow]({e})")
