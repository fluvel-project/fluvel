...
class VBMeta(type(QObject), ABCMeta):
    ...
    All :py:class:`~fluvel.core.abstract_models.AbstractPage.AbstractPage` subclasses inherit from this metaclass to ensure 
...
class AbstractPage(FContainer, ABC, metaclass=VBMeta):
    ...
    All application pages must inherit from :py:class:`~fluvel.core.abstract_models.AbstractPage.AbstractPage` and implement
    the :py:meth:`build_ui` method.

    :cvar app_root: The instance of the main application class (:py:class:`~fluvel.core.App.App`).
    :cvar main_window: The instance of the main window container (:py:class:`~fluvel.core.AppWindow.AppWindow`).
    """

    def __init__(self) -> None:
        """
        Initializes an instance of :py:class:`~fluvel.core.abstract_models.AbstractPage.AbstractPage`.
        """
        super().__init__()
    ...
    def _set_globals(cls, app_root: "App", main_window: AppWindow) -> None:
        ...
        This is called internally by :py:class:`~fluvel.core.SKRouter.Router.init`.

        :param app_root: The root application instance.
        :type app_root: :py:class:`~fluvel.core.SKApp.App`
    ...
    def build_ui(self) -> None:
        ...
        :py:class:`~fluvel.core.abstract_models.AbstractPage.AbstractPage` and is where the entire UI construction logic resides.
        :rtype: None
        """
        pass
...
class Page(AbstractPage, LayoutBuilder):
    """
    Concrete class that inherits from :py:class:`~fluvel.core.abstract_models.AbstractPage.AbstractPage`
